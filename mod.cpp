...
name = "Mark'em";
author = "Im Kreepy";
description = "Mark'em is a mod that marks the position of flares on the map, making it easier for players to locate them and use them effectively in combat situations.";
...
overview = "Mark'em is a mod that marks the position of flares on the map, making it easier for players to locate them and use them effectively in combat situations.";
